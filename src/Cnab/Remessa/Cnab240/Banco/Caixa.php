...
class Caixa extends AbstractRemessa implements RemessaContract
{
    ...
    protected function segmentoP(BoletoContract $boleto)
    {
        ...
        $this->add(38, 39, '00');
        $this->add(40, 40, '0');//Para Nosso Número com 17 posições, informar ‘0’.
        ...
        $this->add(63, 73, Util::formatCnab('9', $boleto->getNumeroDocumento(), 11)); //Campo de preenchimento obrigatório; é o seu controle do título 
        $this->add(74, 77, '');
    ...
    protected function trailerLote()
    {
        ...
        $this->add(8, 8, '5');
        $this->add(9, 17, '');
        $this->add(18, 23, Util::formatCnab('9', count($this->aRegistros[self::DETALHE]) + 2, 6));
